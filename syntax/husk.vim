...
syn region huskUseStatement start='^\s*use\>' end=';' contains=huskUseKeyword,huskPath,huskLocalPath,huskLineComment,huskBlockComment
...
syn region huskStructBlock start='{' end='}' contained contains=huskIdentifier,huskTypeAnnotation,huskLineComment,huskBlockComment
